...
class ChunkingStrategy(LoggerMixin):
    ...
    def __init__(self, 
        ...
        self.logger.info(f"Initialized chunking strategy: size={chunk_size}, overlap={overlap}")
    ...
    def _find_break_point(self, text: str, start: int, end: int) -> int:
        ...
        if sep_pos > self.chunk_size // 2:  # Only use if separator is in the latter half
