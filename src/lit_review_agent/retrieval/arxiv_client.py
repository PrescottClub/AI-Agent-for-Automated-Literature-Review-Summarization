...
class ArxivClient(BaseRetriever, LoggerMixin):
    ...
    async def search_recent(
        ...
        **kwargs
        ...
        recent_items = self.filter_by_date(
            all_items,
    ...
    def _convert_arxiv_result(self, arxiv_result) -> LiteratureItem:
        ...
        return LiteratureItem(
            ...
            metadata={
                ...
                "primary_category": str(arxiv_result.primary_category) if arxiv_result.primary_category else None,
                "links": [str(link) for link in arxiv_result.links] if arxiv_result.links else [],
            }
        )
