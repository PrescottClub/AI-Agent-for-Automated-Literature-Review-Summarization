...
class LiteratureItem(BaseModel):
    ...
    # Metadata
    source: str = Field(..., description="Source of the literature (e.g., 'arxiv', 'pubmed')")
    retrieved_at: datetime = Field(default_factory=datetime.utcnow, description="When item was retrieved")
